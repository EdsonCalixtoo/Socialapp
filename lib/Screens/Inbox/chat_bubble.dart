...
class _ChatBubbleState extends State<ChatBubble> {
  ...
  Color? chatBubbleColor() {
    if (widget.isMe!) {
      return Theme.of(context).colorScheme.secondary; // Substitui accentColor por colorScheme.secondary
    } else {
      ...
      children: <Widget>[
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: Theme.of(context)
                                      .textTheme
                                      .headlineMedium!
                                      .color, // Alterado para headlineMedium
                                  fontSize: 10.0,
                                ),
                                maxLines: 2,
                              ),
                    ...
                    ? !widget.isReply!
                        ? Text(
                            ...
                            style: TextStyle(
                              color: widget.isMe!
                                  ? Colors.white
                                  : Theme.of(context).textTheme.headlineMedium!.color, // Alterado para headlineMedium
                            ),
                          )
                        : Container(
                            alignment: Alignment.centerLeft,
        ...
        Padding(
          ...
          child: Text(
            widget.time!,
            style: TextStyle(
              color: Theme.of(context).textTheme.headlineMedium?.color, // Alterado para headlineMedium
              fontSize: 10.0,
            ),
          ),
        ),
